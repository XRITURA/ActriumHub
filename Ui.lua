...
local Themes = {
    ...
    UBHub = {
        ...
        Tab = Color3.fromRGB(71, 102, 71),
        Element = Color3.fromRGB(71, 102, 71),
        ElementBorder = Color3.fromRGB(50, 50, 50),
        InElementBorder = Color3.fromRGB(80, 80, 80),
        ElementTransparency = 0.75,
        ToggleSlider = Color3.fromRGB(71, 102, 71),
        ToggleToggled = Color3.fromRGB(255, 255, 255),
        SliderRail = Color3.fromRGB(160, 160, 160),
        DropdownFrame = Color3.fromRGB(30, 30, 30),
        DropdownHolder = Color3.fromRGB(50, 50, 50),
        DropdownBorder = Color3.fromRGB(71, 102, 71),
        DropdownOption = Color3.fromRGB(71, 102, 71),
        Keybind = Color3.fromRGB(71, 102, 71),
        Input = Color3.fromRGB(71, 102, 71),
        InputFocused = Color3.fromRGB(0, 0, 0),
        InputIndicator = Color3.fromRGB(88, 127, 64),
        Dialog = Color3.fromRGB(30, 30, 30),
        DialogHolder = Color3.fromRGB(45, 45, 45),
        DialogHolderLine = Color3.fromRGB(71, 102, 71),
        DialogButton = Color3.fromRGB(30, 30, 30),
        DialogButtonBorder = Color3.fromRGB(53, 94, 59),
        DialogBorder = Color3.fromRGB(70, 70, 70),
        DialogInput = Color3.fromRGB(40, 40, 40),
        DialogInputLine = Color3.fromRGB(53, 94, 59),
        Text = Color3.fromRGB(255, 255, 255),
        SubText = Color3.fromRGB(170, 170, 170),
        Hover = Color3.fromRGB(71, 102, 71),
        HoverChange = 0.08,
    },
    Ramadan2025 = {
        Accent = Color3.fromRGB(128, 64, 128),
        AcrylicMain = Color3.fromRGB(20, 20, 30),
        AcrylicBorder = Color3.fromRGB(60, 60, 80),
        AcrylicGradient = ColorSequence.new(Color3.fromRGB(30, 30, 50), Color3.fromRGB(10, 10, 20)),
        AcrylicNoise = 0.8,
        TitleBarLine = Color3.fromRGB(128, 64, 128),
        Tab = Color3.fromRGB(71, 102, 71),
        Element = Color3.fromRGB(71, 102, 71),
        ElementBorder = Color3.fromRGB(50, 50, 50),
        InElementBorder = Color3.fromRGB(80, 80, 80),
        ...
        DropdownBorder = Color3.fromRGB(128, 64, 128),
        DropdownOption = Color3.fromRGB(71, 102, 71),
        Keybind = Color3.fromRGB(71, 102, 71),
        Input = Color3.fromRGB(71, 102, 71),
        InputFocused = Color3.fromRGB(0, 0, 0),
        InputIndicator = Color3.fromRGB(255, 223, 186),
        Dialog = Color3.fromRGB(30, 30, 30),
        DialogHolder = Color3.fromRGB(45, 45, 45),
        DialogHolderLine = Color3.fromRGB(71, 102, 71),
        DialogButton = Color3.fromRGB(30, 30, 30),
        DialogButtonBorder = Color3.fromRGB(128, 64, 128),
        DialogBorder = Color3.fromRGB(70, 70, 70),
        DialogInput = Color3.fromRGB(40, 40, 40),
        DialogInputLine = Color3.fromRGB(53, 94, 59),
        Text = Color3.fromRGB(255, 255, 255),
        SubText = Color3.fromRGB(200, 200, 200),
        Hover = Color3.fromRGB(128, 64, 128),
        HoverChange = 0.08,
    }
}
...
do 
	...
	local GUI1 = game:GetService("CoreGui"):FindFirstChild("UBHubScreenGui")
	if GUI1 then 
		GUI1:Destroy()
	end
end
...
local function CloseOpen()
	...
	Close_ImageButton.Size = UDim2.new(0, 55, 0, 45)
	Close_ImageButton.Image = "rbxassetid://94513440833543"
	...
	return function(Config)
		...
		TitleBar.CloseButton = BarButton(Components.Assets.Close, UDim2.new(1, -4, 0, 4), TitleBar.Frame, function()
			Library.Window:Dialog({
				Title = "Close",
				Content = "You are sure to exit script?",
				Buttons = {
					{
						Title = "Yes",
						Callback = function()
						game:GetService("StarterGui"):SetCore("SendNotification", {
							...
							Text = "Thanks for using UB Hub. \n If you have any suggestion/bug report please let us know!";
...
local InterfaceManager = {} do
	InterfaceManager.Folder = "UBHubConfig"
...
function Library:CreateWindow(Config)
	...
	Library.Theme = Config.Theme or "UBHub"
